    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Administrator'), ('subscriber', 'Subscriber'), ('market_agent', 'Market Agent'), ('caterer', 'Caterer'), ('delivery_person', 'Delivery Person')], default='subscriber', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('service_type', models.CharField(choices=[('catering', 'Catering'), ('delivery', 'Delivery')], max_length=20)),
                ...
                ('max_weight_capacity', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
